...
public class ResideMenu extends FrameLayout {
    ...
    private LinearLayout layoutLeftMenu2;
    ...
    private void initViews(Context context) {
        ...
        layoutLeftMenu2 = (LinearLayout) findViewById(R.id.layout_left_menu2);
    ...
    //添加子菜单项到子菜单2栏里边
    public void addMenuItem2(ResideMenuItem menuItem, int direction) {
        if (direction == DIRECTION_LEFT) {
            this.leftMenuItems.add(menuItem);
            layoutLeftMenu2.addView(menuItem);
        }
    }
