...
public class NewsAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            //如需要更变，需要修改此列表项布局
            //**************************************
            convertView = inflater.inflate(R.layout.layout_health, null);
            //**************************************
            //如需要更变，需要修改此控件ID
            //**************************************
        ...
        viewHolder.head.setImageResource(news.getHead());
        ...
        viewHolder.commentNum.setText("评论数(" + news.getCommentNum() + ")");
        return convertView;
    }
}
