...
public class SportItem1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sport_item1);
        drugtv =(TextView)findViewById(R.id.yundongtv1);
        showView1();
        handler=new Handler() {
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case SUCCESS:
                        Toast.makeText(SportItem1.this, "显示成功", Toast.LENGTH_SHORT).show();
                        drugtv.setText(item1);
                        break;
                    case ERROR:
                        Toast.makeText(SportItem1.this, "显示失败" + msg.obj, Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        };
