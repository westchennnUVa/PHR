...
public class ChronicItem1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chronic_item1);
        drugtv =(TextView)findViewById(R.id.manxingbingtv1);
        showView1();
        handler=new Handler() {
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case SUCCESS:
                        Toast.makeText(ChronicItem1.this, "显示成功", Toast.LENGTH_SHORT).show();
                        drugtv.setText(item1);
                        break;
                    case ERROR:
                        Toast.makeText(ChronicItem1.this, "显示失败"+msg.obj, Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        };
