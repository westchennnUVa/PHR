...
public class RegimenItem1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regemen_item1);

        drugtv =(TextView)findViewById(R.id.yangshengtv1);
        showView1();
        handler=new Handler() {
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case SUCCESS:
                        Toast.makeText(RegimenItem1.this, "显示成功", Toast.LENGTH_SHORT).show();
                        drugtv.setText(item1);
                        break;
                    case ERROR:
                        Toast.makeText(RegimenItem1.this, "显示失败" + msg.obj, Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        };
