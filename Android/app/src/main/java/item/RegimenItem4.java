...
public class RegimenItem4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regimen_item4);
        drugtv =(TextView)findViewById(R.id.yangshengtv4);
        showView1();
        handler=new Handler() {
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case SUCCESS:
                        Toast.makeText(RegimenItem4.this, "显示成功", Toast.LENGTH_SHORT).show();
                        drugtv.setText(item1);
                        break;
                    case ERROR:
                        Toast.makeText(RegimenItem4.this, "显示失败" + msg.obj, Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        };
