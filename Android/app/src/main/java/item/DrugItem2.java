...
public class DrugItem2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drug_item2);
        drugtv =(TextView)findViewById(R.id.yaopintv2);
        showView1();
        handler=new Handler() {
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case SUCCESS:
                        Toast.makeText(DrugItem2.this, "显示成功", Toast.LENGTH_SHORT).show();
                        drugtv.setText(item1);
                        break;
                    case ERROR:
                        Toast.makeText(DrugItem2.this, "显示失败"+msg.obj, Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        };
