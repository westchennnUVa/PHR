...
public class MentalityItem1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mentality_item1);
        drugtv =(TextView)findViewById(R.id.xinlitv1);
        showView1();
        handler=new Handler() {
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case SUCCESS:
                        Toast.makeText(MentalityItem1.this, "显示成功", Toast.LENGTH_SHORT).show();
                        drugtv.setText(item1);
                        break;
                    case ERROR:
                        Toast.makeText(MentalityItem1.this, "显示失败" + msg.obj, Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        };
